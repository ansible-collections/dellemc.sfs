...
sfs_validation_errors
=====================
This task facilitates configuration an GET Validation errors and its attributes through REST calls. The sfs-validation-errors uses the REST API to configure a Dell EMC SmartFabric Services. 
