...
sfs_dns
=======
This task facilitates the configuration of dns server list and its attributes through REST calls. The sfs-dns uses the REST API to configure a Dell EMC SmartFabric Services. 
...
----------------------|---------|-------------------------------------------|------------------|
server_list |	string	| Configures server_list IP addressing   |	Dell Solutions |
address_family  |	string	| Configures address_family    |	Dell Solutions |
