...
====================
This task facilitates the configuration of sfs preferred master and its attributes through REST calls. The sfs preferred master uses the REST API to configure a Dell EMC SmartFabric Services.
...
sfs_preferred_master keys
--------------------------
Key		      |	Type	|	Description			    |	Support        |
----------------------|---------|-------------------------------------------|------------------|
node_id	      |	str	| Configures the node as string      |	Dell Solutions |
preferred_master	      |	bool	| Configures the preferred_master	    |	Dell Solutions |
...
**Inventory**
	...
	[os10]
	node1 ansible_host=100.104.35.73 
