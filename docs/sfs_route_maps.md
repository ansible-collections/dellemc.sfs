...
sfs_route_maps
==============
This module facilitates the configuration of route maps and its attributes through REST calls. It supports CREATE and DELETE operations.The sfs_route_maps role uses REST APIs to configure Dell EMC SmartFabric Services.
