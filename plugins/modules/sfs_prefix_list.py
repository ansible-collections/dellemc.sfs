...
"""
The module file for sfs_prefixlist
"""
...
DOCUMENTATION = """
---
module: sfs_prefixlist
short_description: Configure Prefixlist on Dell SmartFabric Services.
description:
...
class SFSPrefixList(SFSConfig):
    def __init__(self):
        ...
        self.path = "IpPrefixLists"
        self.resource_id = self.module.params['name']


if __name__ == "__main__":
    SFSPrefixList().execute_module()
