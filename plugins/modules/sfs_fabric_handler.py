#!/usr/bin/env python
# pylint: disable=consider-using-f-string, duplicate-key
# -*- coding: utf-8 -*-
...
"""
The module file for sfs_fabric_handler
"""
...
class SFSFabricHandler(SFSConfig):
    def __init__(self):
        argument_spec = {
            'state': {
                'type': 'str',
        ...
        if self.module.params['state'] == "absent":
            ...
            self.path = "Fabrics"
            self.resource_id = self.module.params['fabric_design']


if __name__ == "__main__":
    SFSFabricHandler().execute_module()
